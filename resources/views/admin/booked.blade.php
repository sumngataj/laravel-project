          ...
          <main class="h-full overflow-y-auto">
            ...
            <div class="flex flex-col ">
                ...
                <div class="flex mb-4 ml-4">
                    <button id="tab1" onclick="openTab('tab1')" class="tab-button mr-2 py-2 px-4 text-sm font-medium text-gray-700 bg-transparent border-b-2 border-transparent hover:border-pink-500 focus:outline-none focus:border-pink-500 active:border-pink-500 transition duration-150 ease-in-out active">Pending Reservations</button>
                    <button id="tab2" onclick="openTab('tab2')" class="tab-button py-2 px-4 text-sm font-medium text-gray-700 bg-transparent border-b-2 border-transparent hover:border-pink-500 focus:outline-none focus:border-pink-500 active:border-pink-500 transition duration-150 ease-in-out">Accepted Reservations</button>
                </div>                
                <div id="table-container" class="overflow-x-auto mb-10">
                     <!-- Table 1 -->
                    <div id="tab1-content" class="table-tab-content">
                                                            ...
                                                            {{-- <form
                                                                ...
                                                                <div x-data="{ tooltip: false }" class="relative inline-flex">
                                                                    ...
                                                                    <div class="relative" x-cloak
                                                                        x-show.transition.origin.top="tooltip">
                                                                        <div
                                                                            class="absolute top-0 z-10 w-36 p-2 -mt-1 text-sm leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-red-500 rounded-lg shadow-lg">
                                                                            Cancel Reservation
                                                                        </div>
                    ...
                    <div id="tab2-content" class="hidden table-tab-content">
                        <div class="w-auto m-2 mb-10 border border-gray overflow-hidden rounded-lg shadow-lg">
                            <div class="w-full overflow-x-auto">
                                <table class="w-full whitespace-no-wrap">
                                    <!-- Table Header -->
