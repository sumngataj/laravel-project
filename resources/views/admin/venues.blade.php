                ...
                <div class="w-auto m-2 border border-gray overflow-hidden rounded-lg shadow-lg">
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            '{{ strtolower($venue->location) }}'.includes(search.toLowerCase())">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <p class="font-semibold">{{ $venue->location }}</p>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <p class="font-semibold">{{ $venue->capacity }}</p>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a @click="openEditModal"
                                                class="inline-flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-pink-800 rounded-lg focus:outline-none focus:shadow-outline-gray hover:bg-gray-200"
                                                aria-label="Edit" href="{{ route('venues.edit', $venue->venue_id) }}">
                    ...
                    <div
                        ...
                        <span class="flex items-center col-span-3">
                            Showing {{ $venues->firstItem() }}-{{ $venues->lastItem() }} of {{ $venues->total() }}
                        </span>
