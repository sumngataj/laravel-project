                                        ...
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            >
                                                ...
                                                <div x-data="{ tooltip: false }" class="relative inline-flex">
                                                    <button
                                                        ...
                                                        aria-label="Edit" type="submit"
                                                    >
                                                        <svg class="w-5 h-5" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="green">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                        </svg>
                                                    </button>
                                                    <div class="relative" x-cloak x-show.transition.origin.top="tooltip">
                                                        <div class="absolute top-0 z-10 w-36 p-2 -mt-1 text-sm leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-green-500 rounded-lg shadow-lg">
                                                            Accept Reservation
                                                        </div>
                                            ...
                                            >
                                                ...
                                                <div x-data="{ tooltip: false }" class="relative inline-flex">
                                                    ...
                                                    <div class="relative" x-cloak x-show.transition.origin.top="tooltip">
                                                        <div class="absolute top-0 z-10 w-32 p-2 -mt-1 text-sm leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-pink-500 rounded-lg shadow-lg">
                                                            Accept Booking
                                                        </div>
                                                        <svg class="absolute z-10 w-6 h-6 text-pink-500 transform -translate-x-12 -translate-y-3 fill-current stroke-current" width="8" height="8">
                                                            <rect x="12" y="-10" width="8" height="8" transform="rotate(45)" />
                                                        </svg>
                                                    </div>
                                                </div>
