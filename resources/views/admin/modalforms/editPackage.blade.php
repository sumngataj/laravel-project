        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
              <div class="flex justify-start w-full mt-4 py-2">
                <a href="{{ route('packages.index') }}" class="ml-5 text-2xl italic text-gray-700 relative hover:text-black-900 hover:font-semibold">
                  Package
                </a>
                    ...
                    <div class="mt-8 max-w-4xl">
                      <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-2 sm:col-span-1">
                          <label class="block">
                            <span class="text-gray-700">Package Name</span>
                            <input
                              type="text"
                              name="package_name"
                        ...
                        <div
                          onclick="window.location='{{ route('packages.index') }}';"
