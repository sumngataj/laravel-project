...
<div class="container w-10/12 my-20 mx-auto px-4 md:px-12">
    <p class="text-center uppercase text-gray-400 font-semibold tracking-tight">Photo Gallery</p>
    <h1 class="text-center p-4 text-2xl uppercase font-bold">Featured Portfolio</h1>
    <div class="flex flex-wrap -mx-1 lg:-mx-4"
        ...
        <div class="my-1  px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
            ...
            <article class="overflow-hidden shadow-lg">
                ...
                <a href=" #">
                    <img alt="Placeholder" class="h-auto w-full hover:scale-105 transition-transform duration-300"
                        src="https://images.unsplash.com/photo-1537633552985-df8429e8048b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80"
                        loading="lazy">
                </a>
        ...
        <div class="my-1  px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
            ...
            <article class="overflow-hidden shadow-lg">
                ...
                <a href=" #">
                    <img alt="Placeholder" class="h-auto w-full hover:scale-105 transition-transform duration-300"
                        src="https://images.unsplash.com/photo-1523438885200-e635ba2c371e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80"
                        loading="lazy">
                </a>
        ...
        <div class="my-1  px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
            ...
            <article class="overflow-hidden shadow-lg">
                ...
                <a href=" #">
                    <img alt="Placeholder" class="h-auto w-full hover:scale-105 transition-transform duration-300"
                        src="https://images.unsplash.com/photo-1537633468298-d86f0c2d4173?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80"
                        loading="lazy">
                </a>
