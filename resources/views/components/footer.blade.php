...
<div class="flex flex-wrap justify-between items-start max-w-full p-8 mt-16 shadow-md border-t border-gray-300">
    <div class="flex justify-between items-center ml-32">
        <div>
            ...
            <div class="w-48 text-sm mt-2">
                <span class="font-medium">Address:</span> <span class="font-light"> 118 B. Aquino Street Baranggay Cogon
                    6300, <br>Tagbilaran City, Philippiness</span> <span class="font-medium">Email:</span>
                <span class="text-indigo-600 font-semibold text-sm"> Hannaguidotti1993@icloud.com</span>
            </div>
        </div>
    </div>
    <div class="flex">
            ...
            <div class="mt-2 text-sm">
                <ul>
                    <p class="mb-4 flex items-center justify-center md:justify-start">
                        ...
                        118 B. Aquino Street Baranggay Cogon 6300, <br>Tagbilaran City, Philippines
                    </p>
                    <p class="mb-4 flex items-center justify-center md:justify-start">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="mr-3 h-4 w-4">
